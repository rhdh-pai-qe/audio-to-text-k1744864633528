...
3) Access the `workbench` named `audio-to-text-k1744864633528-notebook`.
...
5) In the terminal, run `cd audio-to-text-k1744864633528` to navigate to your sample app's directory.
